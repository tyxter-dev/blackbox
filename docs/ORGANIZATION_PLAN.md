...
- Phase 3 is in progress: OpenAI Responses and Anthropic Messages have been
  converted into packages with stable public re-exports. The remaining large
  adapters should move one at a time.
