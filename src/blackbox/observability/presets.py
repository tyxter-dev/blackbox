...
from blackbox.observability.metrics import (
    MemoryMetricExporter,
    MetricExporter,
    OpenTelemetryMetricExporter,
    metrics_from_trace,
)
from blackbox.observability.otel import OpenTelemetryTraceExporter
from blackbox.observability.sinks import (
    CompositeEventSink,
    EventSink,
    JSONLEventSink,
    RedactingEventSink,
)
from blackbox.observability.traces import Trace, trace_from_events
...
class ObservabilityPreset:
    ...
    def disabled(cls) -> ObservabilityPreset:
        return cls(service_name="blackbox")
    ...
    def production(
        ...
        *,
        ...
        if logs == "jsonl":
            resolved_log_path = resolved_log_path or Path("blackbox-events.jsonl")
            sinks.append(
                JSONLEventSink(
                    resolved_log_path,
